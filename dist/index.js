...
function ChatUI({
  ...
  footerText = /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
    "Developed by ",
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("a", { href: "https://www.dmanikanta.me", target: "_blank", rel: "noopener noreferrer", className: "hover:underline hover:text-primary transition-colors", children: "Manikanta Darapureddy" }),
    " \u{1F49B}"
  ] }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { id: "chat-ui-scope", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
        ...
        Button2,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-start gap-3 mb-4 w-full", children: [
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "relative h-10 w-10 shrink-0 overflow-hidden rounded-full ring-2 ring-background dark:ring-zinc-800", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                "img",
                {
                  src: logoSrc,
                  alt: "AI",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
      ExpandableChat,
      {
        ...
        icon: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "relative h-full w-full overflow-hidden rounded-full", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
          "img",
          {
            src: logoSrc,
            alt: "AI",
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ExpandableChatBody, { className: "bg-background/50", children: messages.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex flex-col items-center justify-center h-full p-6 text-center animate-in fade-in duration-500", children: [
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "bg-background rounded-full p-4 mb-6 shadow-md ring-1 ring-border/50", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "relative w-16 h-16 overflow-hidden rounded-full", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
              "img",
              {
                src: logoSrc,
                alt: "AI Logo",
              ...
              ChatBubble,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                    ...
                    {
                      variant: message.role === "user" ? "sent" : "received",
                      children: message.role === "user" ? message.content : /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                        "div",
                        {
                          className: cn(
                          ...
                          children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                            import_react_markdown.default,
                            {
                              ...
                              components: {
                                ...
                                ol: ({ node, ...props }) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                                  "ol",
                                  {
                                ...
                                strong: ({ node, ...props }) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                                  "span",
                                  {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(ExpandableChatFooter, { className: "bg-muted/40 p-3", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "mt-2 text-center flex flex-col items-center justify-center gap-0.5", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "text-[10px] text-muted-foreground/60", children: footerText }) })
          ] })
        ]
      }
    )
